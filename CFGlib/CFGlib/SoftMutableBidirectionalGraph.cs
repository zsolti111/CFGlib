...
namespace CFGlib
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        public event EdgeAction<TVertex, TEdge> EdgeUnhidden
        {
            add
            {
                _hideHelper.EdgeUnhidden += value;
            }
            remove
            {
                _hideHelper.EdgeUnhidden -= value;
        ...
        public event VertexAction<TVertex> VertexHidden
        {
            add
            {
                _hideHelper.VertexHidden += value;
            }
            remove
            {
                _hideHelper.VertexHidden -= value;
        ...
        public event VertexAction<TVertex> VertexUnhidden
        {
            add
            {
                _hideHelper.VertexUnhidden += value;
            }
            remove
            {
                _hideHelper.VertexUnhidden -= value;
        ...
        public IEnumerable<TVertex> HiddenVertices
        {
            get
            {
                return _hideHelper.HiddenVertices;
            }
        }
        ...
        public int HiddenVertexCount
        {
            get
            {
                return _hideHelper.HiddenVertexCount;
            }
        }
        ...
        public IEnumerable<TEdge> HiddenEdges
        {
            get
            {
                return _hideHelper.HiddenEdges;
            }
        }
        ...
        public int HiddenEdgeCount
        {
            get
            {
                return _hideHelper.HiddenEdgeCount;
            }
        }
